...
class BeaconRecordServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->service = $this->app->make(BeaconRecordService::class);
        $this->originalArray = [
            ''id' => '1',
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Models\BeaconRecord');
    ...
    public function testUpdate()
    {
        ...
        $this->assertDatabaseHas('beacon_records', $this->editedArray);
    }
