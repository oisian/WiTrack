...
@if (Gate::allows('admin'))
    ...
    <li class="nav-item @if(Request::is('beacons', 'veacons/*')) active @endif">
        <a class="nav-link" href="{!! url('beacons') !!}"><span class="fas fa-lock"></span> Beacons</a>
    </li>
    <li class="nav-item @if(Request::is('beacon_records', 'beacon_records/*')) active @endif">
        <a class="nav-link" href="{!! url('beacon_records') !!}"><span class="fas fa-lock"></span> Beacon records</a>
    </li>
@endif
