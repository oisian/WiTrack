...
Route::resource('beacons', 'BeaconsController', ['except' => ['show']]);
Route::post('beacons/search', [
    'as' => 'beacons.search',
    'uses' => 'BeaconsController@search'
]);


Route::resource('beacon_records', 'BeaconRecordsController', ['except' => ['show']]);
Route::post('beacon_records/search', [
    'as' => 'beacon_records.search',
    'uses' => 'BeaconRecordsController@search'
]);
...
Route::get('kisparse', 'KisParseController@index');
