...
class BeaconRecordService
{
     ...
     * Service Constructor
     *
     * @param BeaconRecord $beacon_record
     */
    public function __construct(BeaconRecord $beacon_record)
    {
        $this->model = $beacon_record;
        $this->pagination = 25;
    }
    ...
    public function search($payload)
    {
        ...
        $columns = Schema::getColumnListing('beacon_records');
